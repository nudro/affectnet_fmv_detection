...
This version does not resize the frame. It writes the entire video at its actual size to .avi video. 
...
with open('fear_written_to_video_60fps.csv', 'w', newline='') as csvfile:
    ...
    while rval:
        ...
        # show result
        # we dont' show this to write to output
